<template>
	<div class="contact">
		...
		<template v-for="(quote, i) in this.quotes">
			<Quote :key="'quote-' + i" v-bind:quote="quote" />
			<hr :key="'hr-' + i" />
		</template>
	</div>
</template>
	...
	data() {
		return {
			quotes: [
				{
					pictures: {
						jpg: require('~/static/people__tom.jpg?resize&size=114'),
						x1: require('~/static/people__tom.jpg?resize&size=114&format=webp'),
						x2: require('~/static/people__tom.jpg?resize&size=228&format=webp')
					},
				...
				{
					pictures: {
						jpg: require('~/static/people__mark.jpg?resize&size=114'),
						x1: require('~/static/people__mark.jpg?resize&size=114&format=webp'),
						x2: require('~/static/people__mark.jpg?resize&size=228&format=webp')
					},
				...
				{
					pictures: {
						jpg: require('~/static/people__edward.jpg?resize&size=114'),
						x1: require('~/static/people__edward.jpg?resize&size=114&format=webp'),
						x2: require('~/static/people__edward.jpg?resize&size=228&format=webp')
					},
					author: 'Edward Wong',
				...
				{
					pictures: {
						jpg: require('~/static/people__sacha.jpg?resize&size=114'),
						x1: require('~/static/people__sacha.jpg?resize&size=114&format=webp'),
						x2: require('~/static/people__sacha.jpg?resize&size=228&format=webp')
					},
					author: 'Sacha Henry',
				...
				{
					pictures: {
						jpg: require('~/static/people__joe.jpg?resize&size=114'),
						x1: require('~/static/people__joe.jpg?resize&size=114&format=webp'),
						x2: require('~/static/people__joe.jpg?resize&size=228&format=webp')
					},
					author: 'Joe da Silva',
				...
				{
					pictures: {
						jpg: require('~/static/people__hamish.jpg?resize&size=114'),
						x1: require('~/static/people__hamish.jpg?resize&size=114&format=webp'),
						x2: require('~/static/people__hamish.jpg?resize&size=228&format=webp')
					},
				...
				{
					pictures: {
						jpg: require('~/static/people__dane.jpg?resize&size=114'),
						x1: require('~/static/people__dane.jpg?resize&size=114&format=webp'),
						x2: require('~/static/people__dane.jpg?resize&size=228&format=webp')
					},
				...
				{
					pictures: {
						jpg: require('~/static/people__cath.jpg?resize&size=114'),
						x1: require('~/static/people__cath.jpg?resize&size=114&format=webp'),
						x2: require('~/static/people__cath.jpg?resize&size=228&format=webp')
					},
					author: 'Cath Hughes',
				...
				{
					pictures: {
						jpg: require('~/static/people__janice.jpg?resize&size=114'),
						x1: require('~/static/people__janice.jpg?resize&size=114&format=webp'),
						x2: require('~/static/people__janice.jpg?resize&size=228&format=webp')
					},
				...
				{
					pictures: {
						jpg: require('~/static/people__sam.jpg?resize&size=114'),
						x1: require('~/static/people__sam.jpg?resize&size=114&format=webp'),
						x2: require('~/static/people__sam.jpg?resize&size=228&format=webp')
					},
					author: 'Sam Hodges',
				...
				{
					pictures: {
						jpg: require('~/static/people__roger.jpg?resize&size=114'),
						x1: require('~/static/people__roger.jpg?resize&size=114&format=webp'),
						x2: require('~/static/people__roger.jpg?resize&size=228&format=webp')
					},
					author: 'Roger Marley',
