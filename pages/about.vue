<template>
	<div class="about">
		...
		<p>
			<strong>I build interfaces:</strong><br />
		...
		<div class="columns columns--icons">
			<div class="child">
				<svg class="icon--big" viewBox="0 0 261.76 226.69" xmlns="http://www.w3.org/2000/svg">
				...
				<ul class="list--plain">
					...
					<li>
						<svg class="icon--inline" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="child">
				<svg class="icon--big" viewBox="0 0 490.6 436.9" xmlns="http://www.w3.org/2000/svg">
					<path fill="none" d="M-1-1h492.6v438.9H-1z" />
					<g>
						<g fill="#61DAFB">
							<path
							...
							/>
							<circle r="45.7" cy="218.5" cx="245.2" />
						</g>
					</g>
				</svg>
				<ul class="list--plain">
